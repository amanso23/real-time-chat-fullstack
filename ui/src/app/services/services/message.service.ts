...
import { setMessagesToSeenByChatId } from '../fn/message/set-messages-to-seen-by-chat-id';
import { SetMessagesToSeenByChatId$Params } from '../fn/message/set-messages-to-seen-by-chat-id';
...
/**
 * A controller for managing messages
 */
...
export class MessageService extends BaseService {
  ...
  /** Path part for operation `setMessagesToSeenByChatId()` */
  static readonly SetMessagesToSeenByChatIdPath = '/api/v1/messages';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `setMessagesToSeenByChatId()` instead.
   *
   * This method doesn't expect any request body.
   */
  setMessagesToSeenByChatId$Response(params: SetMessagesToSeenByChatId$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
    return setMessagesToSeenByChatId(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `setMessagesToSeenByChatId$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  setMessagesToSeenByChatId(params: SetMessagesToSeenByChatId$Params, context?: HttpContext): Observable<void> {
    return this.setMessagesToSeenByChatId$Response(params, context).pipe(
      map((r: StrictHttpResponse<void>): void => r.body)
    );
  }
