...
import { getChatsByReciever } from '../fn/chat/get-chats-by-reciever';
import { GetChatsByReciever$Params } from '../fn/chat/get-chats-by-reciever';
import { StringResponse } from '../models/string-response';


/**
 * A controller for managing chats
 */
...
export class ChatService extends BaseService {
  ...
  /** Path part for operation `getChatsByReciever()` */
  static readonly GetChatsByRecieverPath = '/api/v1/chats';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `getChatsByReciever()` instead.
   *
   * This method doesn't expect any request body.
   */
  getChatsByReciever$Response(params?: GetChatsByReciever$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<ChatResponse>>> {
    return getChatsByReciever(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `getChatsByReciever$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  getChatsByReciever(params?: GetChatsByReciever$Params, context?: HttpContext): Observable<Array<ChatResponse>> {
    return this.getChatsByReciever$Response(params, context).pipe(
